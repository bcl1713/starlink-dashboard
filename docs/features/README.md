...
This category contains user-facing feature descriptions organized by capability
domain. Each document explains what the system can do, use cases, and
limitations.
...
**Finding a specific feature?** Check the [overview](./overview.md) for a
complete catalog.
