...
System requirements and software installation for the Starlink Dashboard.
...
Once software is installed, proceed to verification:

**[Verification Steps →](./prerequisites-verification.md)**
