...
Prometheus service alias in this profile. STARLINK_HISTORY_WINDOW_SECONDS is an
optional bootstrap default for the Mission Planner overview query lookback.
...
STARLINK_APP_DATA_PATH/settings/overview-history.json. This display/query window
is independent of Prometheus database retention (PROMETHEUS_RETENTION).
