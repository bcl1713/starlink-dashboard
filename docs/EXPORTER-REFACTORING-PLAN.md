...
### Files to Refactor
- **exporter.py** (2220 lines) - Single-leg timeline export with 4 formats (CSV, XLSX, PDF, PPTX)
- **package_exporter.py** (1298 lines) - Mission-level packaging and archive creation
- **Total:** 3518 lines, highly interdependent

### Current Architecture Issues
1. **Mixed Concerns:** Formatting, data processing, rendering, and packaging all in two files
2. **Visualization Bloat:** Map/chart generation adds ~700 lines to exporter.py
3. **Code Reuse Problems:** Combined export functions duplicate pagination/styling logic from single-leg exports
4. **Tight Coupling:** Manager dependencies deeply nested in visualization code
...
3. **Maintainability**
   ...
   - Visualization improvements isolated to render_*.py
