...
Enable mission planners to adjust mission leg departure times without modifying KML files. Users specify a new departure time, and the system automatically recalculates all waypoint times, timeline segments, and exports while preserving route geometry and satellite configurations.
