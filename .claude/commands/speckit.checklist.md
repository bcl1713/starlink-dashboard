...
1. **Clarify intent (dynamic)**: Derive up to THREE initial contextual
   ...
   1. Identify probable audience & timing (author, reviewer, QA, release) if not
      explicit.
   1. Detect missing dimensions: scope breadth, depth/rigor, risk emphasis,
...
1. **Structure Reference**: Generate the checklist following the canonical
...
1. **Report**: Output full path to created checklist, item count, and remind
