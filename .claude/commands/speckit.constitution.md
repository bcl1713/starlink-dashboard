...
1. Consistency propagation checklist (convert prior checklist into active
   validations):
...
1. Produce a Sync Impact Report (prepend as an HTML comment at top of the
...
1. Write the completed constitution back to `.specify/memory/constitution.md`
   (overwrite).
